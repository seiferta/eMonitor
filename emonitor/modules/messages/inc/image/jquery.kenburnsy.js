...
;(function ( $, window, document, undefined ) {
    ...
    var _transitions = {
        ...
        moveRight: function (slide, duration) {
          $(slide)
            .velocity({
              translateX: '-50%',
              scale: '2'
        ...
        moveLeft: function (slide, duration) {
          $(slide)
            .velocity({
              translateX: '200px',
              scale: '2'
        ...
        moveUp: function (slide, duration) {
          $(slide)
            .velocity({
              translateY: '200px',
              scale: '2'
        ...
        moveDown: function (slide, duration) {
          $(slide)
            .velocity({
              translateY: '-50%',
              scale: '2'
      ...
      */
      animate: function (index) {
        var keys = Object.keys(_transitions),
            ...
            //transition = _transitions['moveUp']

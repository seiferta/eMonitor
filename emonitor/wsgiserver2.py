...
class ThreadPool(object):
    ...
    def grow(self, amount):
        ...
        for i in range(amount):
            if 0 < self.max <= len(self._threads):
                break
...
class CherryPyWSGIServer(HTTPServer):
    ...
    def __init__(self, bind_addr, wsgi_app, numthreads=10, server_name=None,
                 max=-1, request_queue_size=5, timeout=10, shutdown_timeout=5, accepted_queue_size=100, accepted_queue_timeout=0):
        ...
        self.accepted_queue_size = accepted_queue_size
